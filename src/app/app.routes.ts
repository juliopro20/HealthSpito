...
import { RecordDashboard } from './dashboards/patient-dashboards/record-dashboard/record-dashboard';
import { ChatDashboard } from './dashboards/patient-dashboards/chat-dashboard/chat-dashboard';

...
@Component({
  selector: 'app-hospitals-features',
  imports: [CommonModule, Footer],
  templateUrl: './hospitals-features.html',
  styleUrl: './hospitals-features.css'
})
export class HospitalsFeatures {
  featuresArray = [
    ...
    onBoardHospital() {
      this.router.navigate(['/hospital-onboarding']).then(() => {

...
@Component({
  selector: 'app-mid-wife-feature',
  imports: [CommonModule, Footer],
  templateUrl: './mid-wife-feature.html',
  styleUrl: './mid-wife-feature.css'
})
export class MidWifeFeature {
    featuresArray = [
    ...
    onBoardMidwife() {
      this.router.navigate(['/midwife-onboarding']).then(() => {

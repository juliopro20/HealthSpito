...
@Component({
  selector: 'app-pharmacy-features',
  imports: [CommonModule, Footer],
  templateUrl: './pharmacy-features.html',
  styleUrl: './pharmacy-features.css'
})
export class PharmacyFeatures {
   featuresArray = [
    ...
    onBoardPharmacy() {
      this.router.navigate(['/pharmacy-onboarding']).then(() => {

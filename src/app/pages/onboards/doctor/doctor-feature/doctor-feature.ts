...
@Component({
  selector: 'app-doctor-feature',
  imports: [CommonModule, Footer, CommonModule],
  templateUrl: './doctor-feature.html',
  styleUrl: './doctor-feature.css'
})
export class DoctorFeature {
    featuresArray = [
    ...
    onBoardDoctor() {
      this.router.navigate(['/doctor-onboarding']).then(() => {

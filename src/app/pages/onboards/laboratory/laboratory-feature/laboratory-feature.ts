...
@Component({
  selector: 'app-laboratory-feature',
  imports: [CommonModule, Footer],
  templateUrl: './laboratory-feature.html',
  styleUrl: './laboratory-feature.css'
})
export class LaboratoryFeature {
featuresArray = [
    ...
    onBoardLaboratory() {
      this.router.navigate(['/laboratory-onboarding']).then(() => {
